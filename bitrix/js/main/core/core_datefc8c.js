		...
		this.DIV = BX.create('DIV', {
			...
			children: [
				...
				(this.PARTS.TIME = BX.create('DIV', {
					...
					html: '<a href="javascript:void(0)" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php" class="bx-calendar-set-time"><i></i>'+BX.message('CAL_TIME_SET')+'</a><div class="bx-calendar-form-block"><span class="bx-calendar-form-text">'+BX.message('CAL_TIME')+'</span><span class="bx-calendar-form"><input type="text" class="bx-calendar-form-input" maxwidth="2" onkeyup="BX.calendar.get()._check_time()" /><span class="bx-calendar-form-separator"></span><input type="text" class="bx-calendar-form-input" maxwidth="2" onkeyup="BX.calendar.get()._check_time()" />'+(this.bAmPm?'<span class="bx-calendar-AM-PM-block"><span class="bx-calendar-AM-PM-text" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php"></span><span class="bx-calendar-form-arrow-r"><a href="javascript:void(0)" class="bx-calendar-form-arrow-top" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php"><i></i></a><a href="javascript:void(0)" class="bx-calendar-form-arrow-bottom" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php"><i></i></a></span></span>':'')+'</span><a href="javascript:void(0)" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php" class="bx-calendar-form-close"><i></i></a></div>'
				})),
				...
				BX.create('DIV', {
					...
					html: '<a href="javascript:void(0)" class="bx-calendar-button bx-calendar-button-select" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php"><span class="bx-calendar-button-left"></span><span class="bx-calendar-button-text">'+BX.message('CAL_BUTTON')+'</span><span class="bx-calendar-button-right"></span></a><a href="javascript:void(0)" class="bx-calendar-button bx-calendar-button-cancel" data-action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php"><span class="bx-calendar-button-left"></span><span class="bx-calendar-button-text">'+BX.message('JS_CORE_WINDOW_CLOSE')+'</span><span class="bx-calendar-button-right"></span></a>'
				})
			]
		});
...
BX.CClockSelector.prototype.Show = function()
{
	if (!this.isReady)
	{
		...
		return BX.ajax.get('clock_selector.php', {start_time: this.params.start_time, clock_id: this.CLOCK_ID, sessid: BX.bitrix_sessid()}, BX.delegate(this.Ready, this));
	}

...
<!-- bitrix/tools/clock_selector.php :26:39 GMT -->
...
<meta name="keywords" content="Двери межкомнатные, двери входные, раздвижные, стеклянные по низким ценам" />
<meta name="description" content="Установка межкомнатных и входных дверей, доставка  раздвижных, стеклянных, скрытых дверей" />
<link href="../js/main/core/css/core.min694f.css?14695142642854" type="text/css"  rel="stylesheet" />
<link href="../panel/main/popup.mine1bc.css?146951426420704" type="text/css"  data-template-style="true"  rel="stylesheet" />
<link href="../panel/main/login.mina874.css?146951426427313" type="text/css"  data-template-style="true"  rel="stylesheet" />
<script type="text/javascript">if(!window.BX)window.BX={message:function(mess){if(typeof mess=='object') for(var i in mess) BX.message[i]=mess[i]; return true;}};</script>
<script type="text/javascript">(window.BX||top.BX).message({'JS_CORE_LOADING':'Загрузка...','JS_CORE_NO_DATA':'- Нет данных -','JS_CORE_WINDOW_CLOSE':'Закрыть','JS_CORE_WINDOW_EXPAND':'Развернуть','JS_CORE_WINDOW_NARROW':'Свернуть в дверь','JS_CORE_WINDOW_SAVE':'Сохранить','JS_CORE_WINDOW_CANCEL':'Отменить','JS_CORE_WINDOW_CONTINUE':'Продолжить','JS_CORE_H':'ч','JS_CORE_M':'м','JS_CORE_S':'с','JSADM_AI_HIDE_EXTRA':'Скрыть лишние','JSADM_AI_ALL_NOTIF':'Показать все','JSADM_AUTH_REQ':'Требуется авторизация!','JS_CORE_WINDOW_AUTH':'Войти','JS_CORE_IMAGE_FULL':'Полный размер'});</script>
<script type="text/javascript">(window.BX||top.BX).message({'LANGUAGE_ID':'ru','FORMAT_DATE':'DD.MM.YYYY','FORMAT_DATETIME':'DD.MM.YYYY HH:MI:SS','COOKIE_PREFIX':'BITRIX_SM','SERVER_TZ_OFFSET':'10800','USER_ID':'','SERVER_TIME':'1474986352','USER_TZ_OFFSET':'0','USER_TZ_AUTO':'Y','bitrix_sessid':'4305463339810a0bd112c678b3202ea4'});</script>


<script type="text/javascript" src="../js/main/core/core.min225b.js?146951426470993"></script>
<script type="text/javascript" src="../js/main/core/core_ajax.min74fa.js?146951426420978"></script>
<script type="text/javascript" src="../js/main/core/core_window.min35a2.js?146951426474917"></script>
<script type="text/javascript" src="../js/main/core/core_admin_login.min0e5a.js?146951426414601"></script>


<title>Авторизация - Двери - Цены</title>
</head>
			...
			<td class="login-popup-alignment-2" id="popup_alignment">
				<div class="login-header">
					<a href="../../index.html" class="login-logo">
						<span class="login-logo-img"></span><span class="login-logo-text">xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais</span>
					</a>
					<div class="login-language-btn-wrap"><div class="login-language-btn" id="login_lang_button">RU</div></div>
				</div>

				<div class="login-footer">
					<div class="login-footer-left">  <a href="http://www.1c-bitrix.ru/">1С-Битрикс: Управление сайтом</a>. &copy; Битрикс, 2016</div>
					<div class="login-footer-right">
						<a href="http://www.1c-bitrix.ru/support/" class="login-footer-link">Техподдержка</a>					</div>
				</div>
				<form name="form_auth" method="post" target="auth_frame" class="bx-admin-auth-form" action="http://xn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais/send.php" novalidate>
...
<div class="login-main-popup-wrap login-popup-wrap" id="authorize">
	...
	<div class="login-popup-network-block">
		...
		<span class="login-popup-network-btn login-popup-network-btn-ru" onclick="BX.util.popup('https://www.bitrix24.net/oauth/authorize/?user_lang=ru&amp;client_id=ext.579702211252e3.07017021&amp;redirect_uri=http%3A%2F%2Fxn----ctbffpbookzq.xn--80aaa0acqr.xn--90ais%2Fbitrix%2Ftools%2Fclock_selector.php%3Fauth_service_id%3DBitrix24Net&amp;scope=auth,admin&amp;response_type=code&amp;mode=popup&amp;state=admin%3D1%26backurl%3D%252Fbitrix%252Ftools%252Fclock_selector.php%253Fcheck_key%253D2fbffad84de1320a6c5cde148733b7f8%26mode%3Dpopup', 800, 600);"></span>
	</div>
...
BX.adminLogin.registerForm(new BX.authFormAuthorize('authorize', {url: '/bitrix/tools/clock_selector.php?login=yes'}));
					...
					<input type="hidden" name="sessid" id="sessid" value="4305463339810a0bd112c678b3202ea4" />				</form>
			</td>
		</tr>
	</table>
...
<script type="text/javascript">
BX.adminLogin.registerForm(new BX.authFormOtp('otp', {url: '/bitrix/tools/clock_selector.php'}));
</script>
...
BX.ready(BX.defer(function(){
	...
	setTimeout(function() {
		BX.load(['/bitrix/panel/main/admin.css?1469514264109631','../panel/main/admin-public186b.css?146951426479803','../panel/main/adminstyles_fixedc868.css?146951426421115','/bitrix/themes/.default/modules.css?147426048926783']);
		BX.load(['/bitrix/js/main/utils.js?146951426430973','../js/main/admin_tools9062.js?146951426467477','../js/main/popup_menuc02c.js?146951426412913','../js/main/admin_search8605.js?14695142647251','../js/main/dd7f3f.js?146951426414761','../js/main/core/core_popup64e8.js?146951426442190','../js/main/core/core_datefc8c.js?146951426453512','../js/main/core/core_admin_interface91a5.js?1469514264128550','../js/main/core/core_autosaveb6ad.js?14695142648979','/bitrix/js/main/core/core_fx.js?146951426416538']);
	}, 2000);
}));

new BX.COpener({DIV: 'login_lang_button', ACTIVE_CLASS: 'login-language-btn-active', MENU: [{'TEXT':'(ru) Russian','LINK':'/bitrix/tools/clock_selector.php?lang=ru'},{'TEXT':'(en) English','LINK':'/bitrix/tools/clock_selector.php?lang=en'}]});
</script>
</body>

<!-- bitrix/tools/clock_selector.php :26:48 GMT -->
</html>
